...
1. Write the JSON schema describing your resource, `organization-service-resource.json`
2. Implement your resource handlers in `organization_service_resource/handlers.py`
